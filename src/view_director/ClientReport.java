...
public class ClientReport extends JFrame {
	...
	public static String сlient_name_to_look;
	 ...
	 * @throws SQLException 
	 */
	public ClientReport(JFrame parent) throws SQLException 
	{
		...
		ClientComboBox.setBounds(38, 51, 430, 34);
		...
		SelectButton.addActionListener(new ActionListener() 
		{
			...
			{
				сlient_name_to_look = String.valueOf(ClientComboBox.getSelectedItem());
				for(Client Client : clients) 
				{
					client_id_to_look = Client.getId();
					if(Client.getName().equals(сlient_name_to_look))
					{
						break;
					}
				}
		...
		InfoButton.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e)
			{
				...
				ClientReport.this.setVisible(false);
				try {
					new ClientInformation(ClientReport.this).setVisible(true);
				} catch (SQLException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
