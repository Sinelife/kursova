...
public class DeliveryDepartmentDirectorMenu extends JFrame {
	 ...
	 * Create the frame.
	 */
	public DeliveryDepartmentDirectorMenu()
	{
		...
		JLabel MenuTitleLabel = new JLabel("Меню роботи з відділом постачання");
		MenuTitleLabel.setFont(new Font("Tahoma", Font.PLAIN, 21));
		MenuTitleLabel.setBounds(67, 27, 417, 38);
		contentPane.add(MenuTitleLabel);
		
		JButton InfoButton = new JButton("1)Переглянути звіти про замовлення постачання.");
		...
		JButton AddButton = new JButton("2)Переглянути звіти про постачальників.");
		AddButton.addActionListener(new ActionListener() 
		{
			public void actionPerformed(ActionEvent e) 
			{
				...
				try {
					new ProviderReport(DeliveryDepartmentDirectorMenu.this).setVisible(true);
